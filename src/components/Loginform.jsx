    ...
    return ( 
        ...
        <form className='max-w-[400px] w-full mx-auto rounded-lg bg-gray- p-6 px-2'>
            ...
            <div className='flex flex-col py-2'>
                ...
                <input className='p-2 rounded-lg border-2 mt-2 focus:border-green-500 focus:outline-none' type="password" placeholder="Kindly enter your password" />
            </div>
            <div className='flex justify-between text-gray-400 py-2'>
                <p className='flex items-center'>*Minimum 4 Characters</p>
                
            </div>
            <button className='w-full my-5 py-2 bg-[#BBFF4B] shadow-lg shadow-black-500/50 hover:shadow-teal-500/40 text-[#28743A] text-[1rem] font-normal rounded-full'>Log In</button>
